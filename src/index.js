...
import {Provider} from 'react-redux';//importando redux
...
const store=createStore(reducer, initalState, composeEnhancer());
...
/**
 * incluimos los providers primeros pasos en react-redux
 */